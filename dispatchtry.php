...
ON patrolcar.patrolcar_status_id=patrol_status.patrolcar_status_id 
...
$sql = "INSERT INTO incident (caller_name, phone_number, incident_type_id, incident_location, incident_desc, incident_status_id) VALUES('".$_POST['callerName']."',
...
for($i=0; $i < $numOfPatrocarDispatched; $i++)
{
  ...
  $sql = "INSERT INTO dispatch (incident_id, patrolcar_id, time_dispatched) VALUES ($incidentID, '".$patrolcarDispatched[$i].
  ...
  // insert dispatch data
  $sql = "INSERT INTO dispatch (incident_id, patrolcar_id, time_dispatched) VALUES ($incidentId, '".$patrolcar
...
<table>
  ...
  <?php
	...
	// retrieve from patrolcar table those patrol cars that are 2: Patrol or 3: Free
	$sql = "SELECT patrolcar_id, patrolcar_status_desc FROM patrolcar JOIN patrolcar_status
	ON patrolcar.patrolcar_status_id='2' OR patrolcar.patrolcar_status_id='3'";
